function [NextObs, Reward, IsDone, NextState] = GliderNewStepFunction2(Action, State)
...
% x minimum for the glider i.e it must crash after x = 210
xMinimum = 1500;
...
IsDone = NextState(2) < yTresholdEnd;
